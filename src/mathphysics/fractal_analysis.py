...
class FractalGenerator:
    ...
    @jit(nopython=True)
    def julia_point(
        z_real: float, z_imag: float, c_real: float, c_imag: float, max_iter: int = 100
    ) -> int:
...
class FractalDimensionCalculator:
    ...
    def box_counting_dimension(
        ...
        slope, _intercept, r_value, p_value, std_err = linregress(log_inv_scales, log_counts)
        dimension = slope
        ...
        return FractalDimensionResult(
            ...
            metadata={"num_points": len(points), "num_scales": num_scales, "p_value": p_value},
        )
    ...
    def hausdorff_dimension(
        ...
        slope, _intercept, r_value, p_value, std_err = linregress(log_scales, log_measures)
        dimension = -slope
        ...
        return FractalDimensionResult(
            ...
            confidence_interval=confidence_interval,
            metadata={"num_points": len(points), "method": method, "p_value": p_value},
        )
    ...
    def correlation_dimension(
        ...
        slope, _intercept, r_value, p_value, std_err = linregress(log_scales, log_corr)
        dimension = slope
    ...
    def information_dimension(
        ...
        slope, _intercept, r_value, p_value, std_err = linregress(
        ...
        return FractalDimensionResult(
            ...
            confidence_interval=confidence_interval,
            metadata={"num_points": len(points), "p_value": p_value},
        )
...
class SelfSimilarityAnalyzer:
    ...
    @staticmethod
    def find_scaling_ratio(
        points: np.ndarray, test_scales: list[float] | None = None
    ) -> dict[str, Any]:
        ...
        for scale in test_scales:
            ...
            results[scale] = {"error": min_error, "translation": best_translation}
    ...
    @staticmethod
    def lacunarity(image: np.ndarray, box_sizes: list[int] | None = None) -> dict[str, Any]:
...
def analyze_fractal_dimensions(output_dir: Path | None = None) -> dict[str, Any]:
