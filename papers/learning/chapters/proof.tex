...
\input{papers/learning/generated/proof_entry}

\lessoncue{Notice}{Choose the domain before deciding whether an example covers the statement.}
...
\begin{learningcard}[breakable=false]{Historical situation: a diagram and its obligations}
...
\input{papers/learning/generated/proof_ready}
