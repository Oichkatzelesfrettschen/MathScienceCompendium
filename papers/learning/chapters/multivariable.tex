...
\input{papers/learning/generated/multivariable_entry}
...
\lessoncue{Notice}{Hold the other inputs fixed for a partial derivative, then ask whether the full local map exists.}
...
\begin{learningcard}[breakable=false]{Historical situation: notation as shared equipment}
...
\[M'(t)=-[J]_0^L=J(0,t)-J(L,t),\]
where $M=\int_0^L\rho\,dx$.
...
\input{papers/learning/generated/multivariable_ready}
