...
\input{papers/learning/generated/algebra_entry}
...
\lessoncue{Notice}{Apply two operations in both orders before computing their commutator.}
...
\begin{learningcard}[breakable=false]{Historical situation: classification requires definitions}
...
\begin{figure}[htbp]
  \centering
  \input{papers/learning/figures/root_hexagon.tex}
...
\[
 ...
 \tfrac12(\pm1,\ldots,\pm1)\text{ with even minus parity}.
 \end{gathered}
\]
...
\input{papers/learning/generated/algebra_ready}
