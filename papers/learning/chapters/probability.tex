...
\input{papers/learning/generated/probability_entry}
...
\lessoncue{Notice}{Count the observed positives before choosing the denominator.}
...
\begin{figure}[htbp]
  \centering
  \input{papers/learning/figures/bayes_tree.tex}
...
\begin{learningcard}[breakable=false]{Historical situation: a paper communicated by another reader}
...
\paragraph{Solution.}
The formula gives
\[\sqrt{(1/2)(1/2)/100}=0.05,\qquad
\sqrt{(1/2)(1/2)/400}=0.025.\]
Both numbers describe the sampling
...
\input{papers/learning/generated/probability_ready}
