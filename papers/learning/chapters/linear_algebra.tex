...
\input{papers/learning/generated/linear_algebra_entry}

Bring coordinate vectors, dot products, matrix multiplication, and systems
of equations from Chapter~\ref{learn:matrix_maps}; use Chapter~\ref{learn:proof} for quantified statements.
...
\lessoncue{Notice}{A column records the image of one basis vector; compare the map with its coordinates.}
...
\begin{learningcard}[breakable=false]{Historical situation: an algebra of transformations}
...
\begin{figure}[htbp]
  \centering
  \input{papers/learning/figures/linear_map.tex}
...
\lessoncue{Helpful analysis for this proof}{The argument imports compactness and differentiation. Read the calculation examples first; return after Chapters~\ref{learn:calculus} and~\ref{learn:geometry} to examine those inputs.}
...
\input{papers/learning/generated/linear_algebra_ready}
