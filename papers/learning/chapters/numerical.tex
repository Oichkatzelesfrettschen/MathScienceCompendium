...
\input{papers/learning/generated/numerical_entry}
...
\lessoncue{Notice}{Compare the numerical result with an independent target before interpreting its digits.}
...
\begin{learningcard}[breakable=false]{Historical situation: reliable matrix computation}
...
\input{papers/learning/generated/numerical_ready}
