...
\input{papers/learning/generated/dynamics_entry}
...
\lessoncue{Notice}{Compare decay in the differential equation with the amplification factor of one numerical step.}
...
\begin{learningcard}[breakable=false]{Historical situation: heat and a research program}
...
\input{papers/learning/generated/dynamics_ready}
