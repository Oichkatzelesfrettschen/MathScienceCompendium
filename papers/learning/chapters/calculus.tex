...
\input{papers/learning/generated/calculus_entry}
...
\lessoncue{Notice}{The increment appears in both a numerator and a denominator before the limit is taken.}


\section{A limit is a controlled error statement}
For a function defined near $a$, except possibly at $a$, write the limit assertion as
\[\lim_{x\to a}f(x)=L.\]
The assertion means: for every $\epsilon>0$ there exists
...
\begin{learningcard}[breakable=false]{Historical situation: motion as a mathematical problem}
...
\input{papers/learning/generated/calculus_ready}
