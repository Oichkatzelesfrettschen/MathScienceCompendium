...
\input{papers/learning/generated/geometry_entry}
...
from Chapter~\ref{learn:complex_numbers}. Three questions guide this chapter: what does ``nearby''
...
\lessoncue{Notice}{Count the intervals and measure their lengths at the same construction stage.}
...
\begin{figure}[htbp]
  \centering
  \input{papers/learning/figures/cantor_construction.tex}
...
\begin{learningcard}[breakable=false]{Historical situation: a measurement question changes with scale}
...
\input{papers/learning/generated/geometry_ready}
