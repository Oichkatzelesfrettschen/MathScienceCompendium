...
\begin{itemize}
    ...
    \item Type 2 roots (length $\sqrt{2}$): 128 YES
    \item Cartan matrix determinant: $\det(A) = 1$ YES
\end{itemize}
See \texttt{src/mathphysics/algebras/roots.py} for the root-system implementation.
\end{proof}
...
Using \texttt{src/mathphysics/algebras/roots.py}, we check:
