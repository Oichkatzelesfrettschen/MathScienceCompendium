...
\begin{longtable}{lrrrrrrrr}
  ...
  \midrule
  \endhead
  \input{generated/review_cayley_property_rows.tex}
\end{longtable}
\normalsize
...
A modular form is defined by holomorphy and a transformation law under a
specified subgroup of $\mathrm{SL}(2,\ZZ)$. The classical modular invariant has
the expansion
...
$j$ led to monstrous moonshine, proved through the construction of a monstrous
Lie superalgebra \citep{conway1979monstrous,borcherds1992monstrous}.
