...
even-checkerboard kernel, which falsifies $E_7$ specificity in the primary audit
before a dynamical run. In the primary 540-run beta-plane program, the required
...
four-jet conclusion, both algebraic-filter explanations, and the registered
transient-zonalization claim are therefore falsified for their declared
implementations and parameter domain. Their manuscript admission remains
withheld until the clean re-execution and promotion gates pass.
