...
\paragraph{Evidence beside the decisions.}
In the \evidencerecord{hypothesis_registry.json}{hypothesis registry}, search
\nolinkurl{hyp_e7_nonhomomorphic_fourier_selector} for the exact specificity
statement and \nolinkurl{hyp_beta_plane_transient_zonalization} for the locked
fluid-model conjunction. The same identifiers in the
\evidencerecord{independent_reproduction_registry.json}{reproduction registry}
locate the retained repeat, inputs, and decision. The former equality result
falsifies specificity in its registered cases; the latter reports non-support
of the conjunction in a freely decaying model.
