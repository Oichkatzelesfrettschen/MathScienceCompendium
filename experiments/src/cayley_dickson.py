...
class CayleyDickson:
    ...
    def __init__(self, coefficients: Union[np.ndarray, List[float], float]):
...
class Sedenion(CayleyDickson):
    ...
    def find_zero_divisors(trials: int = 100) -> List[Tuple[Sedenion, Sedenion]]:
        ...
        for _ in range(trials):
            ...
            a = Sedenion.random(scale=1.0)
            b = Sedenion.random(scale=1.0)
...
class CayleyDicksonValidator:
    ...
    def __init__(self, algebra_class: type):
